...
% FIXME toms: evlt. könnte man die nachfolgenden Absätze als
% Listenpunkte formatieren. Dann im vorigen Absatz "werden." -> "werden:" ersetzen.
...
% FIXME toms: hier könnte man die einzelnen Schritte in einer
% "enumerate" Umgebung auszeichnen:
...
Nach der Einführungsphase ist das Tool in die Firmenrichtlinie \anf{Nutzung interner Entwicklungstools}
aufgenommen worden.
\pagebreak
